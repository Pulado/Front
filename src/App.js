...
import WordsStack from './Componentes/palavras/wordsStack';
import Keyboard from './Componentes/teclado/teclado';
import sorteador from './Componentes/Quadrado/words';
import PopUp from './Componentes/avisos/popUp';
import Label from './Componentes/avisos/label';
      ...
      if (keyLetter === 'enter'){
        ...
        if (currentpalavraArray[currentIndex].content.trim().length < 5){
          ...
          if(sorteador.includes(lastEntry)){
            ...
            ViewLabel('Essa palavra não é aceita', 6000);
          }
